...
def main():
    ...
    for k in range(0, iterations):
        ...
        with open("training_set_noise_1.node_features") as data:
            data = list(data)
            random.shuffle(data)
            for t in range(0, len(data)):
                ...
                if t % validateStep == 0:
                    ...
                    with open("test_set_noise_1.node_features") as validate:
                        while True:
    ...
    with open("test_set_noise_1.node_features") as data:
        while True:
